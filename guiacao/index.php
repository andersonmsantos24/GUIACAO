...
$tituloDaPagina = "Bem-vindo ao Guiacão";
include 'header.php';
?>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-6 text-center text-lg-start">
            <div class="text-center">
                <h1 class="display-4">Bem-vindo ao GuiaCão!</h1>
                <p class="fs-5 text-muted">Seu recurso completo para informações sobre cães de Raça.</p>
                <hr class="my-4">
